...
const jpgavif = () =>
  src('./_input/_images_to_size/**/*.jpg')
    .pipe(
      sharpResponsive({
        formats: [
          // jpeg
          {
            width: 640,
            format: 'jpeg',
            jpegOptions: { quality: 65, progressive: true },
            rename: { suffix: '-640' },
          },
          {
            width: 880,
            format: 'jpeg',
            jpegOptions: { quality: 59, progressive: true },
            rename: { suffix: '-880' },
          },
          {
            width: 1024,
            format: 'jpeg',
            jpegOptions: { quality: 49, progressive: true },
            rename: { suffix: '-1024' },
          },
          {
            width: 1920,
          ...
          { width: 640, format: 'avif', avifOptions: { quality: 49 }, rename: { suffix: '-640' } },
          {
            width: 880,
            format: 'avif',
            avifOptions: { quality: 49 },
            rename: { suffix: '-880' },
          },
          {
            width: 1024,
...
gulp.task('curatename', function (done) {
  ...
  return (
    gulp
      .src('./_input/_images_to_rename/**/*.jpg')
      .pipe(
        rename(function (fix) {
...
gulp.task(function lowercase(done) {
  return gulp
    .src('./_input/_images_to_lowercase/**/*.*')
    .pipe(
      rename(function (fix) {
        fix.basename = changeCase.lowerCase(fix.basename);
      })
